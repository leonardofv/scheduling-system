    ...
    <div className="space-y-8">
        ...
        <div id="secoes" className="grid grid-cols-1 gap-6">
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm hover:shadow-md transition-shadow">
            ...
            <h3 className="text-lg font-semibold text-gray-900 flex items-center justify-center mb-2">Serviços</h3>
            <p className="text-sm text-gray-600 flex items-center justify-center mb-4">Confira os serviços disponíveis para agendamento.</p>
            <button
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm hover:shadow-md transition-shadow">
            ...
            <h3 className="text-lg font-semibold text-gray-900 flex items-center justify-center mb-2">Relatórios</h3>
            <p className="text-sm text-gray-600 flex items-center justify-center mb-4">Análise dos seus agendamentos em gráficos e tabelas.</p>
            <button
