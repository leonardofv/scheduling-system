...
export default function DashboardPage() {
  ...
  return (
    <div id="inicio" className="space-y-8">
      <section className="relative overflow-hidden rounded-2xl border border-emerald-200 bg-gradient-to-br from-emerald-50 via-white to-blue-50 px-6 py-10 sm:px-10">
        <div className="absolute -right-16 -top-20 h-56 w-56 rounded-full bg-emerald-200/50 blur-3xl" aria-hidden="true" />
        <div className="absolute -bottom-24 right-28 h-52 w-52 rounded-full bg-blue-200/40 blur-3xl" aria-hidden="true" />

        <div className="relative max-w-2xl">
          <span className="inline-flex items-center gap-2 rounded-full bg-white/80 px-3 py-1 text-xs font-semibold tracking-wide text-emerald-700 shadow-sm ring-1 ring-emerald-100">
            <span className="h-2 w-2 rounded-full bg-emerald-500" />
            SUA SAÚDE, NO SEU RITMO
          </span>
          <h1 className="mt-5 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
            Organize seus cuidados de forma simples.
          </h1>
          <p className="mt-3 max-w-xl text-base leading-7 text-gray-600">
            Centralize consultas, exames e informações importantes em um só lugar. Assim, sobra mais tempo para cuidar de você.
          </p>
