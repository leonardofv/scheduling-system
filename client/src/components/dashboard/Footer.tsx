        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              <div className="inline-flex items-center justify-center w-10 h-10 rounded-lg bg-emerald-600">
          ...
          <div>
            ...
            <div className="space-y-2">
              <p className="text-sm">
                ...
                <a href="mailto:suporte@agendafacil.com" className="hover:text-emerald-400 transition-colors">
                  suporte@agendafacil.com
                </a>
              </p>
              <p className="text-sm">
                <span className="text-gray-400">Telefone:</span>{" "}
                <a href="tel:+55112345678" className="hover:text-emerald-400 transition-colors">
                  +55 (11) 2345-678
                </a>
              </p>
            </div>
